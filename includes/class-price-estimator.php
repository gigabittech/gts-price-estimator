...
class Price_Estimator {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Price_Estimator_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'Price_Estimator_VERSION' ) ) {
			$this->version = Price_Estimator_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'price-estimator';
	 ...
	 *
	 * - Price_Estimator_Loader. Orchestrates the hooks of the plugin.
	 * - Price_Estimator_i18n. Defines internationalization functionality.
	 * - Price_Estimator_Admin. Defines all hooks for the admin area.
	 * - Price_Estimator_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-price-estimator-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-price-estimator-i18n.php';
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'assets/public/class-price-estimator-public.php';

		$this->loader = new Price_Estimator_Loader();
	 ...
	 *
	 * Uses the Price_Estimator_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Price_Estimator_i18n();
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Price_Estimator_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Price_Estimator_Loader    Orchestrates the hooks of the plugin.
	 */
